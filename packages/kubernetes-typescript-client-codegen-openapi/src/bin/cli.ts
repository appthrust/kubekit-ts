...
if (!semver.satisfies(tsVersion, '>=4.1 <=4.5')) {
  console.warn(
    'Please note that `kahirokunn/kubernetes-typescript-client-codegen-openapi` only has been tested with TS versions 4.1 to 4.5 - other versions might cause problems.'
  );
}
