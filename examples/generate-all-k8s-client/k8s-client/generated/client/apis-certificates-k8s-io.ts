...
export const getCertificatesApiGroup = (
  args: GetCertificatesApiGroupApiArg,
  options?: Options
) => {
  return apiClient<GetCertificatesApiGroupApiResponse>(
    { path: `/apis/certificates.k8s.io/` },
    options
  )
}
export type GetCertificatesApiGroupApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiGroup
export type GetCertificatesApiGroupApiArg = void
