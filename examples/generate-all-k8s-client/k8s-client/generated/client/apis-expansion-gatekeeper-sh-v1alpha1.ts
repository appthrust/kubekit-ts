...
export const createExpansionGatekeeperShV1Alpha1ExpansionTemplate = (
  args: CreateExpansionGatekeeperShV1Alpha1ExpansionTemplateApiArg,
  options?: Options
) => {
  return apiClient<CreateExpansionGatekeeperShV1Alpha1ExpansionTemplateApiResponse>(
    {
      path: `/apis/expansion.gatekeeper.sh/v1alpha1/expansiontemplate`,
      method: 'POST',
      body: args.shGatekeeperExpansionV1Alpha1ExpansionTemplate,
      params: {
        pretty: args.pretty,
        dryRun: args.dryRun,
...
export const readExpansionGatekeeperShV1Alpha1ExpansionTemplate = (
  args: ReadExpansionGatekeeperShV1Alpha1ExpansionTemplateApiArg,
  options?: Options
) => {
  return apiClient<ReadExpansionGatekeeperShV1Alpha1ExpansionTemplateApiResponse>(
    {
      path: `/apis/expansion.gatekeeper.sh/v1alpha1/expansiontemplate/${args.name}`,
      params: { pretty: args.pretty, resourceVersion: args.resourceVersion },
    },
    options
  )
}
export const replaceExpansionGatekeeperShV1Alpha1ExpansionTemplate = (
  args: ReplaceExpansionGatekeeperShV1Alpha1ExpansionTemplateApiArg,
  options?: Options
) => {
  return apiClient<ReplaceExpansionGatekeeperShV1Alpha1ExpansionTemplateApiResponse>(
    {
      path: `/apis/expansion.gatekeeper.sh/v1alpha1/expansiontemplate/${args.name}`,
      method: 'PUT',
      body: args.shGatekeeperExpansionV1Alpha1ExpansionTemplate,
...
export const deleteExpansionGatekeeperShV1Alpha1ExpansionTemplate = (
  args: DeleteExpansionGatekeeperShV1Alpha1ExpansionTemplateApiArg,
  options?: Options
) => {
  return apiClient<DeleteExpansionGatekeeperShV1Alpha1ExpansionTemplateApiResponse>(
    {
      path: `/apis/expansion.gatekeeper.sh/v1alpha1/expansiontemplate/${args.name}`,
      method: 'DELETE',
...
export const patchExpansionGatekeeperShV1Alpha1ExpansionTemplate = (
  args: PatchExpansionGatekeeperShV1Alpha1ExpansionTemplateApiArg,
  options?: Options
) => {
  return apiClient<PatchExpansionGatekeeperShV1Alpha1ExpansionTemplateApiResponse>(
    {
      path: `/apis/expansion.gatekeeper.sh/v1alpha1/expansiontemplate/${args.name}`,
      method: 'PATCH',
...
export type CreateExpansionGatekeeperShV1Alpha1ExpansionTemplateApiArg = {
  ...
  shGatekeeperExpansionV1Alpha1ExpansionTemplate: ShGatekeeperExpansionV1Alpha1ExpansionTemplate
}
export type DeleteExpansionGatekeeperShV1Alpha1CollectionExpansionTemplateApiResponse =
...
export type ReadExpansionGatekeeperShV1Alpha1ExpansionTemplateApiResponse =
  /** status 200 OK */ ShGatekeeperExpansionV1Alpha1ExpansionTemplate
...
export type PatchExpansionGatekeeperShV1Alpha1ExpansionTemplateApiResponse =
  /** status 200 OK */ ShGatekeeperExpansionV1Alpha1ExpansionTemplate
...
export type ShGatekeeperExpansionV1Alpha1ExpansionTemplate = {
  apiVersion?: string | undefined
  ...
  spec?:
    | {
        applyTo?:
          ...
          | undefined
        enforcementAction?: string | undefined
        generatedGVK?:
          | {
...
export type ShGatekeeperExpansionV1Alpha1ExpansionTemplateList = {
  apiVersion?: string | undefined
  items: ShGatekeeperExpansionV1Alpha1ExpansionTemplate[]
  kind?: string | undefined
