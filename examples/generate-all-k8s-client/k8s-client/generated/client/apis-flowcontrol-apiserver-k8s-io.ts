...
export const getFlowcontrolApiserverApiGroup = (
  args: GetFlowcontrolApiserverApiGroupApiArg,
  options?: Options
) => {
  return apiClient<GetFlowcontrolApiserverApiGroupApiResponse>(
    { path: `/apis/flowcontrol.apiserver.k8s.io/` },
    options
  )
}
export type GetFlowcontrolApiserverApiGroupApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiGroup
export type GetFlowcontrolApiserverApiGroupApiArg = void
