...
export const getCoordinationV1ApiResources = (
  ...
  return apiClient<GetCoordinationV1ApiResourcesApiResponse>(
...
export const createCoordinationV1NamespacedLease = (
  ...
  return apiClient<CreateCoordinationV1NamespacedLeaseApiResponse>(
    {
      path: `/apis/coordination.k8s.io/v1/namespaces/${args['namespace']}/leases`,
      method: 'POST',
      body: args.body,
...
export const deleteCoordinationV1CollectionNamespacedLease = (
  args: DeleteCoordinationV1CollectionNamespacedLeaseApiArg,
  options?: Options
) => {
  return apiClient<DeleteCoordinationV1CollectionNamespacedLeaseApiResponse>(
    {
      path: `/apis/coordination.k8s.io/v1/namespaces/${args['namespace']}/leases`,
      method: 'DELETE',
      body: args.body,
...
export const readCoordinationV1NamespacedLease = (
  ...
  return apiClient<ReadCoordinationV1NamespacedLeaseApiResponse>(
    {
...
export const replaceCoordinationV1NamespacedLease = (
  ...
  return apiClient<ReplaceCoordinationV1NamespacedLeaseApiResponse>(
    {
      path: `/apis/coordination.k8s.io/v1/namespaces/${args['namespace']}/leases/${args.name}`,
      method: 'PUT',
      body: args.body,
...
export const deleteCoordinationV1NamespacedLease = (
  ...
  return apiClient<DeleteCoordinationV1NamespacedLeaseApiResponse>(
    {
      path: `/apis/coordination.k8s.io/v1/namespaces/${args['namespace']}/leases/${args.name}`,
      method: 'DELETE',
      body: args.body,
...
export const patchCoordinationV1NamespacedLease = (
  ...
  return apiClient<PatchCoordinationV1NamespacedLeaseApiResponse>(
    {
      path: `/apis/coordination.k8s.io/v1/namespaces/${args['namespace']}/leases/${args.name}`,
      method: 'PATCH',
      body: args.body,
...
export type GetCoordinationV1ApiResourcesApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiResourceList
export type GetCoordinationV1ApiResourcesApiArg = void
export type ListCoordinationV1LeaseForAllNamespacesApiResponse =
  /** status 200 OK */ IoK8SApiCoordinationV1LeaseList
export type ListCoordinationV1LeaseForAllNamespacesApiArg = {
...
export type ListCoordinationV1NamespacedLeaseApiResponse =
  /** status 200 OK */ IoK8SApiCoordinationV1LeaseList
...
export type ReadCoordinationV1NamespacedLeaseApiArg = {
  /** name of the Lease */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type WatchCoordinationV1NamespacedLeaseListApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent
export type WatchCoordinationV1NamespacedLeaseListApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchCoordinationV1NamespacedLeaseApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent
export type WatchCoordinationV1NamespacedLeaseApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
