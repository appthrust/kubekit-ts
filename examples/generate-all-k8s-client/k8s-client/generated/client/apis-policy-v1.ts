...
export const getPolicyV1ApiResources = (
  ...
  return apiClient<GetPolicyV1ApiResourcesApiResponse>(
    { path: `/apis/policy/v1/` },
    options
  )
}
...
export const createPolicyV1NamespacedPodDisruptionBudget = (
  args: CreatePolicyV1NamespacedPodDisruptionBudgetApiArg,
  options?: Options
) => {
  return apiClient<CreatePolicyV1NamespacedPodDisruptionBudgetApiResponse>(
    {
      path: `/apis/policy/v1/namespaces/${args['namespace']}/poddisruptionbudgets`,
      method: 'POST',
      body: args.ioK8SApiPolicyV1PodDisruptionBudget,
      params: {
        pretty: args.pretty,
        dryRun: args.dryRun,
...
export const deletePolicyV1CollectionNamespacedPodDisruptionBudget = (
  args: DeletePolicyV1CollectionNamespacedPodDisruptionBudgetApiArg,
  options?: Options
) => {
  return apiClient<DeletePolicyV1CollectionNamespacedPodDisruptionBudgetApiResponse>(
    {
      path: `/apis/policy/v1/namespaces/${args['namespace']}/poddisruptionbudgets`,
      method: 'DELETE',
...
export const readPolicyV1NamespacedPodDisruptionBudget = (
  args: ReadPolicyV1NamespacedPodDisruptionBudgetApiArg,
  options?: Options
) => {
  return apiClient<ReadPolicyV1NamespacedPodDisruptionBudgetApiResponse>(
    {
...
export const replacePolicyV1NamespacedPodDisruptionBudget = (
  args: ReplacePolicyV1NamespacedPodDisruptionBudgetApiArg,
  options?: Options
) => {
  return apiClient<ReplacePolicyV1NamespacedPodDisruptionBudgetApiResponse>(
    {
      path: `/apis/policy/v1/namespaces/${args['namespace']}/poddisruptionbudgets/${args.name}`,
      method: 'PUT',
      body: args.ioK8SApiPolicyV1PodDisruptionBudget,
...
export const deletePolicyV1NamespacedPodDisruptionBudget = (
  args: DeletePolicyV1NamespacedPodDisruptionBudgetApiArg,
  options?: Options
) => {
  return apiClient<DeletePolicyV1NamespacedPodDisruptionBudgetApiResponse>(
    {
      path: `/apis/policy/v1/namespaces/${args['namespace']}/poddisruptionbudgets/${args.name}`,
      method: 'DELETE',
      body: args.ioK8SApimachineryPkgApisMetaV1DeleteOptions,
...
export const patchPolicyV1NamespacedPodDisruptionBudget = (
  args: PatchPolicyV1NamespacedPodDisruptionBudgetApiArg,
  options?: Options
) => {
  return apiClient<PatchPolicyV1NamespacedPodDisruptionBudgetApiResponse>(
    {
      path: `/apis/policy/v1/namespaces/${args['namespace']}/poddisruptionbudgets/${args.name}`,
      method: 'PATCH',
...
export const readPolicyV1NamespacedPodDisruptionBudgetStatus = (
  args: ReadPolicyV1NamespacedPodDisruptionBudgetStatusApiArg,
  options?: Options
) => {
  return apiClient<ReadPolicyV1NamespacedPodDisruptionBudgetStatusApiResponse>(
    {
...
export const replacePolicyV1NamespacedPodDisruptionBudgetStatus = (
  args: ReplacePolicyV1NamespacedPodDisruptionBudgetStatusApiArg,
  options?: Options
) => {
  return apiClient<ReplacePolicyV1NamespacedPodDisruptionBudgetStatusApiResponse>(
    {
      path: `/apis/policy/v1/namespaces/${args['namespace']}/poddisruptionbudgets/${args.name}/status`,
      method: 'PUT',
      body: args.ioK8SApiPolicyV1PodDisruptionBudget,
...
export const patchPolicyV1NamespacedPodDisruptionBudgetStatus = (
  args: PatchPolicyV1NamespacedPodDisruptionBudgetStatusApiArg,
  options?: Options
) => {
  return apiClient<PatchPolicyV1NamespacedPodDisruptionBudgetStatusApiResponse>(
    {
      path: `/apis/policy/v1/namespaces/${args['namespace']}/poddisruptionbudgets/${args.name}/status`,
      method: 'PATCH',
      body: args.ioK8SApimachineryPkgApisMetaV1Patch,
...
export type GetPolicyV1ApiResourcesApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiResourceList
export type GetPolicyV1ApiResourcesApiArg = void
export type ListPolicyV1NamespacedPodDisruptionBudgetApiResponse =
...
export type DeletePolicyV1CollectionNamespacedPodDisruptionBudgetApiResponse =
...
export type ReadPolicyV1NamespacedPodDisruptionBudgetApiResponse =
  /** status 200 OK */ IoK8SApiPolicyV1PodDisruptionBudget
export type ReadPolicyV1NamespacedPodDisruptionBudgetApiArg = {
...
export type ReadPolicyV1NamespacedPodDisruptionBudgetStatusApiResponse =
  /** status 200 OK */ IoK8SApiPolicyV1PodDisruptionBudget
export type ReadPolicyV1NamespacedPodDisruptionBudgetStatusApiArg = {
  /** name of the PodDisruptionBudget */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type ListPolicyV1PodDisruptionBudgetForAllNamespacesApiResponse =
  /** status 200 OK */ IoK8SApiPolicyV1PodDisruptionBudgetList
export type ListPolicyV1PodDisruptionBudgetForAllNamespacesApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchPolicyV1NamespacedPodDisruptionBudgetListApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent
export type WatchPolicyV1NamespacedPodDisruptionBudgetListApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchPolicyV1NamespacedPodDisruptionBudgetApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent
export type WatchPolicyV1NamespacedPodDisruptionBudgetApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchPolicyV1PodDisruptionBudgetListForAllNamespacesApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent
export type WatchPolicyV1PodDisruptionBudgetListForAllNamespacesApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type IoK8SApiPolicyV1PodDisruptionBudgetSpec = {
  maxUnavailable?: IoK8SApimachineryPkgUtilIntstrIntOrString | undefined
  minAvailable?: IoK8SApimachineryPkgUtilIntstrIntOrString | undefined
  selector?: IoK8SApimachineryPkgApisMetaV1LabelSelector | undefined
  unhealthyPodEvictionPolicy?: ('AlwaysAllow' | 'IfHealthyBudget') | undefined
}
...
export type IoK8SApiPolicyV1PodDisruptionBudgetStatus = {
  conditions?: IoK8SApimachineryPkgApisMetaV1Condition[] | undefined
  currentHealthy: number
  desiredHealthy: number
  disruptedPods?:
    | {
        [key: string]: IoK8SApimachineryPkgApisMetaV1Time
      }
    | undefined
...
export type IoK8SApiPolicyV1PodDisruptionBudget = {
  apiVersion?: string | undefined
  kind?: string | undefined
  metadata?: IoK8SApimachineryPkgApisMetaV1ObjectMeta | undefined
  spec?: IoK8SApiPolicyV1PodDisruptionBudgetSpec | undefined
  status?: IoK8SApiPolicyV1PodDisruptionBudgetStatus | undefined
}
...
export type IoK8SApiPolicyV1PodDisruptionBudgetList = {
  apiVersion?: string | undefined
