...
export const getApiextensionsV1ApiResources = (
  args: GetApiextensionsV1ApiResourcesApiArg,
  options?: Options
) => {
  return apiClient<GetApiextensionsV1ApiResourcesApiResponse>(
    { path: `/apis/apiextensions.k8s.io/v1/` },
    options
  )
}
export const listApiextensionsV1CustomResourceDefinition = (
  args: ListApiextensionsV1CustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<ListApiextensionsV1CustomResourceDefinitionApiResponse>(
    {
...
export const createApiextensionsV1CustomResourceDefinition = (
  args: CreateApiextensionsV1CustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<CreateApiextensionsV1CustomResourceDefinitionApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions`,
      method: 'POST',
      body: args.ioK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition,
      params: {
        pretty: args.pretty,
        dryRun: args.dryRun,
...
export const deleteApiextensionsV1CollectionCustomResourceDefinition = (
  args: DeleteApiextensionsV1CollectionCustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<DeleteApiextensionsV1CollectionCustomResourceDefinitionApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions`,
      method: 'DELETE',
...
export const readApiextensionsV1CustomResourceDefinition = (
  args: ReadApiextensionsV1CustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<ReadApiextensionsV1CustomResourceDefinitionApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions/${args.name}`,
...
export const replaceApiextensionsV1CustomResourceDefinition = (
  args: ReplaceApiextensionsV1CustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<ReplaceApiextensionsV1CustomResourceDefinitionApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions/${args.name}`,
      method: 'PUT',
      body: args.ioK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition,
...
export const deleteApiextensionsV1CustomResourceDefinition = (
  args: DeleteApiextensionsV1CustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<DeleteApiextensionsV1CustomResourceDefinitionApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions/${args.name}`,
      method: 'DELETE',
      body: args.ioK8SApimachineryPkgApisMetaV1DeleteOptions,
...
export const patchApiextensionsV1CustomResourceDefinition = (
  args: PatchApiextensionsV1CustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<PatchApiextensionsV1CustomResourceDefinitionApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions/${args.name}`,
      method: 'PATCH',
      body: args.body,
...
export const readApiextensionsV1CustomResourceDefinitionStatus = (
  args: ReadApiextensionsV1CustomResourceDefinitionStatusApiArg,
  options?: Options
) => {
  return apiClient<ReadApiextensionsV1CustomResourceDefinitionStatusApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions/${args.name}/status`,
      params: { pretty: args.pretty },
    },
    options
  )
...
export const replaceApiextensionsV1CustomResourceDefinitionStatus = (
  args: ReplaceApiextensionsV1CustomResourceDefinitionStatusApiArg,
  options?: Options
) => {
  return apiClient<ReplaceApiextensionsV1CustomResourceDefinitionStatusApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions/${args.name}/status`,
      method: 'PUT',
      body: args.ioK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition,
...
export const patchApiextensionsV1CustomResourceDefinitionStatus = (
  args: PatchApiextensionsV1CustomResourceDefinitionStatusApiArg,
  options?: Options
) => {
  return apiClient<PatchApiextensionsV1CustomResourceDefinitionStatusApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions/${args.name}/status`,
      method: 'PATCH',
      body: args.body,
...
export const watchApiextensionsV1CustomResourceDefinitionList = (
  args: WatchApiextensionsV1CustomResourceDefinitionListApiArg,
  options?: Options
) => {
  return apiClient<WatchApiextensionsV1CustomResourceDefinitionListApiResponse>(
    {
...
export const watchApiextensionsV1CustomResourceDefinition = (
  args: WatchApiextensionsV1CustomResourceDefinitionApiArg,
  options?: Options
) => {
  return apiClient<WatchApiextensionsV1CustomResourceDefinitionApiResponse>(
    {
      path: `/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/${args.name}`,
      params: {
        allowWatchBookmarks: args.allowWatchBookmarks,
        continue: args['continue'],
        fieldSelector: args.fieldSelector,
...
export type GetApiextensionsV1ApiResourcesApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiResourceList
export type GetApiextensionsV1ApiResourcesApiArg = void
export type ListApiextensionsV1CustomResourceDefinitionApiResponse =
  /** status 200 OK */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList
export type ListApiextensionsV1CustomResourceDefinitionApiArg = {
...
export type CreateApiextensionsV1CustomResourceDefinitionApiResponse =
  /** status 200 OK */
    | IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
    | /** status 201 Created */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
    | /** status 202 Accepted */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
export type CreateApiextensionsV1CustomResourceDefinitionApiArg = {
  /** If 'true', then the output is pretty printed. */
  pretty?: string
...
export type DeleteApiextensionsV1CollectionCustomResourceDefinitionApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1Status
export type DeleteApiextensionsV1CollectionCustomResourceDefinitionApiArg = {
  /** If 'true', then the output is pretty printed. */
  pretty?: string
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type ReadApiextensionsV1CustomResourceDefinitionApiResponse =
  /** status 200 OK */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
export type ReadApiextensionsV1CustomResourceDefinitionApiArg = {
  /** name of the CustomResourceDefinition */
  name: string
  /** If 'true', then the output is pretty printed. */
  pretty?: string
}
export type ReplaceApiextensionsV1CustomResourceDefinitionApiResponse =
  /** status 200 OK */
    | IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
    | /** status 201 Created */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
export type ReplaceApiextensionsV1CustomResourceDefinitionApiArg = {
  /** name of the CustomResourceDefinition */
  name: string
  /** If 'true', then the output is pretty printed. */
  pretty?: string
...
export type DeleteApiextensionsV1CustomResourceDefinitionApiResponse =
  /** status 200 OK */
    | IoK8SApimachineryPkgApisMetaV1Status
    | /** status 202 Accepted */ IoK8SApimachineryPkgApisMetaV1Status
export type DeleteApiextensionsV1CustomResourceDefinitionApiArg = {
  /** name of the CustomResourceDefinition */
  name: string
  /** If 'true', then the output is pretty printed. */
  pretty?: string
...
export type PatchApiextensionsV1CustomResourceDefinitionApiResponse =
  /** status 200 OK */
    | IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
    | /** status 201 Created */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
export type PatchApiextensionsV1CustomResourceDefinitionApiArg = {
  /** name of the CustomResourceDefinition */
  name: string
  /** If 'true', then the output is pretty printed. */
  pretty?: string
...
export type ReadApiextensionsV1CustomResourceDefinitionStatusApiResponse =
  /** status 200 OK */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
export type ReadApiextensionsV1CustomResourceDefinitionStatusApiArg = {
  /** name of the CustomResourceDefinition */
  name: string
  /** If 'true', then the output is pretty printed. */
  pretty?: string
}
export type ReplaceApiextensionsV1CustomResourceDefinitionStatusApiResponse =
  /** status 200 OK */
    | IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
    | /** status 201 Created */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
export type ReplaceApiextensionsV1CustomResourceDefinitionStatusApiArg = {
  /** name of the CustomResourceDefinition */
  name: string
  /** If 'true', then the output is pretty printed. */
  pretty?: string
...
export type PatchApiextensionsV1CustomResourceDefinitionStatusApiResponse =
  /** status 200 OK */
    | IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
    | /** status 201 Created */ IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
export type PatchApiextensionsV1CustomResourceDefinitionStatusApiArg = {
  /** name of the CustomResourceDefinition */
  name: string
  /** If 'true', then the output is pretty printed. */
  pretty?: string
...
export type WatchApiextensionsV1CustomResourceDefinitionListApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent
export type WatchApiextensionsV1CustomResourceDefinitionListApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type WatchApiextensionsV1CustomResourceDefinitionApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1WatchEvent
export type WatchApiextensionsV1CustomResourceDefinitionApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type IoK8SApiextensionsApiserverPkgApisApiextensionsV1JsonSchemaProps = {
  ...
  anyOf?:
    | IoK8SApiextensionsApiserverPkgApisApiextensionsV1JsonSchemaProps[]
    | undefined
  default?: IoK8SApiextensionsApiserverPkgApisApiextensionsV1Json | undefined
  definitions?:
    | {
        [
          key: string
  ...
  dependencies?:
    ...
    | undefined
  description?: string | undefined
  enum?: IoK8SApiextensionsApiserverPkgApisApiextensionsV1Json[] | undefined
  example?: IoK8SApiextensionsApiserverPkgApisApiextensionsV1Json | undefined
  ...
  'x-kubernetes-embedded-resource'?: boolean | undefined
  'x-kubernetes-int-or-string'?: boolean | undefined
  'x-kubernetes-list-map-keys'?: string[] | undefined
  'x-kubernetes-list-type'?: string | undefined
  'x-kubernetes-map-type'?: string | undefined
  'x-kubernetes-preserve-unknown-fields'?: boolean | undefined
...
export type IoK8SApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionStatus =
  {
    ...
    conditions?:
      ...
      | undefined
    storedVersions?: string[] | undefined
  }
