...
export const getStorageApiGroup = (
  args: GetStorageApiGroupApiArg,
  options?: Options
) => {
  return apiClient<GetStorageApiGroupApiResponse>(
    { path: `/apis/storage.k8s.io/` },
    options
  )
}
export type GetStorageApiGroupApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiGroup
export type GetStorageApiGroupApiArg = void
