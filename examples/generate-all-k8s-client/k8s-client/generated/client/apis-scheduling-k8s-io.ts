...
export const getSchedulingApiGroup = (
  args: GetSchedulingApiGroupApiArg,
  options?: Options
) => {
  return apiClient<GetSchedulingApiGroupApiResponse>(
    { path: `/apis/scheduling.k8s.io/` },
    options
  )
}
export type GetSchedulingApiGroupApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiGroup
export type GetSchedulingApiGroupApiArg = void
