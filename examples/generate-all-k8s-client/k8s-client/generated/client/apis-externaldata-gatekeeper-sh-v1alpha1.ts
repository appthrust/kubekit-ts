...
export const createExternaldataGatekeeperShV1Alpha1Provider = (
  args: CreateExternaldataGatekeeperShV1Alpha1ProviderApiArg,
  options?: Options
) => {
  return apiClient<CreateExternaldataGatekeeperShV1Alpha1ProviderApiResponse>(
    {
      path: `/apis/externaldata.gatekeeper.sh/v1alpha1/providers`,
      method: 'POST',
      body: args.shGatekeeperExternaldataV1Alpha1Provider,
      params: {
        pretty: args.pretty,
        dryRun: args.dryRun,
...
export const readExternaldataGatekeeperShV1Alpha1Provider = (
  args: ReadExternaldataGatekeeperShV1Alpha1ProviderApiArg,
  options?: Options
) => {
  return apiClient<ReadExternaldataGatekeeperShV1Alpha1ProviderApiResponse>(
    {
      path: `/apis/externaldata.gatekeeper.sh/v1alpha1/providers/${args.name}`,
      params: { pretty: args.pretty, resourceVersion: args.resourceVersion },
    },
    options
  )
}
export const replaceExternaldataGatekeeperShV1Alpha1Provider = (
  args: ReplaceExternaldataGatekeeperShV1Alpha1ProviderApiArg,
  options?: Options
) => {
  return apiClient<ReplaceExternaldataGatekeeperShV1Alpha1ProviderApiResponse>(
    {
      path: `/apis/externaldata.gatekeeper.sh/v1alpha1/providers/${args.name}`,
      method: 'PUT',
      body: args.shGatekeeperExternaldataV1Alpha1Provider,
...
export const deleteExternaldataGatekeeperShV1Alpha1Provider = (
  args: DeleteExternaldataGatekeeperShV1Alpha1ProviderApiArg,
  options?: Options
) => {
  return apiClient<DeleteExternaldataGatekeeperShV1Alpha1ProviderApiResponse>(
    {
      path: `/apis/externaldata.gatekeeper.sh/v1alpha1/providers/${args.name}`,
      method: 'DELETE',
...
export const patchExternaldataGatekeeperShV1Alpha1Provider = (
  args: PatchExternaldataGatekeeperShV1Alpha1ProviderApiArg,
  options?: Options
) => {
  return apiClient<PatchExternaldataGatekeeperShV1Alpha1ProviderApiResponse>(
    {
      path: `/apis/externaldata.gatekeeper.sh/v1alpha1/providers/${args.name}`,
      method: 'PATCH',
...
export type CreateExternaldataGatekeeperShV1Alpha1ProviderApiArg = {
  ...
  shGatekeeperExternaldataV1Alpha1Provider: ShGatekeeperExternaldataV1Alpha1Provider
}
...
export type ReadExternaldataGatekeeperShV1Alpha1ProviderApiResponse =
  /** status 200 OK */ ShGatekeeperExternaldataV1Alpha1Provider
...
export type PatchExternaldataGatekeeperShV1Alpha1ProviderApiResponse =
  /** status 200 OK */ ShGatekeeperExternaldataV1Alpha1Provider
...
export type ShGatekeeperExternaldataV1Alpha1Provider = {
  apiVersion?: string | undefined
...
export type ShGatekeeperExternaldataV1Alpha1ProviderList = {
  apiVersion?: string | undefined
  items: ShGatekeeperExternaldataV1Alpha1Provider[]
  kind?: string | undefined
