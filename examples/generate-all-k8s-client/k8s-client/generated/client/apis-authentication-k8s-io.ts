...
export const getAuthenticationApiGroup = (
  args: GetAuthenticationApiGroupApiArg,
  options?: Options
) => {
  return apiClient<GetAuthenticationApiGroupApiResponse>(
    { path: `/apis/authentication.k8s.io/` },
    options
  )
}
export type GetAuthenticationApiGroupApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1ApiGroup
export type GetAuthenticationApiGroupApiArg = void
