...
export const createTelemetryIstioIoV1Alpha1NamespacedTelemetry = (
  args: CreateTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg,
  options?: Options
) => {
  return apiClient<CreateTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse>(
    {
      path: `/apis/telemetry.istio.io/v1alpha1/namespaces/${args['namespace']}/telemetries`,
      method: 'POST',
      body: args.ioIstioTelemetryV1Alpha1Telemetry,
      params: {
        pretty: args.pretty,
        dryRun: args.dryRun,
...
export const readTelemetryIstioIoV1Alpha1NamespacedTelemetry = (
  args: ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg,
  options?: Options
) => {
  return apiClient<ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse>(
    {
...
export const replaceTelemetryIstioIoV1Alpha1NamespacedTelemetry = (
  args: ReplaceTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg,
  options?: Options
) => {
  return apiClient<ReplaceTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse>(
    {
      path: `/apis/telemetry.istio.io/v1alpha1/namespaces/${args['namespace']}/telemetries/${args.name}`,
      method: 'PUT',
      body: args.ioIstioTelemetryV1Alpha1Telemetry,
...
export const deleteTelemetryIstioIoV1Alpha1NamespacedTelemetry = (
  args: DeleteTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg,
  options?: Options
) => {
  return apiClient<DeleteTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse>(
    {
      path: `/apis/telemetry.istio.io/v1alpha1/namespaces/${args['namespace']}/telemetries/${args.name}`,
      method: 'DELETE',
...
export const patchTelemetryIstioIoV1Alpha1NamespacedTelemetry = (
  args: PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg,
  options?: Options
) => {
  return apiClient<PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse>(
    {
      path: `/apis/telemetry.istio.io/v1alpha1/namespaces/${args['namespace']}/telemetries/${args.name}`,
      method: 'PATCH',
      body: args.body,
...
export const readTelemetryIstioIoV1Alpha1NamespacedTelemetryStatus = (
  args: ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiArg,
  options?: Options
) => {
  return apiClient<ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiResponse>(
    {
...
export const replaceTelemetryIstioIoV1Alpha1NamespacedTelemetryStatus = (
  args: ReplaceTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiArg,
  options?: Options
) => {
  return apiClient<ReplaceTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiResponse>(
    {
      path: `/apis/telemetry.istio.io/v1alpha1/namespaces/${args['namespace']}/telemetries/${args.name}/status`,
      method: 'PUT',
      body: args.ioIstioTelemetryV1Alpha1Telemetry,
...
export const patchTelemetryIstioIoV1Alpha1NamespacedTelemetryStatus = (
  args: PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiArg,
  options?: Options
) => {
  return apiClient<PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiResponse>(
    {
      path: `/apis/telemetry.istio.io/v1alpha1/namespaces/${args['namespace']}/telemetries/${args.name}/status`,
      method: 'PATCH',
      body: args.body,
...
export type ListTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse =
...
export type CreateTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg = {
  ...
  ioIstioTelemetryV1Alpha1Telemetry: IoIstioTelemetryV1Alpha1Telemetry
}
export type DeleteTelemetryIstioIoV1Alpha1CollectionNamespacedTelemetryApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1Status
export type DeleteTelemetryIstioIoV1Alpha1CollectionNamespacedTelemetryApiArg =
  {
    /** object name and auth scope, such as for teams and projects */
    namespace: string
    /** If 'true', then the output is pretty printed. */
...
export type ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse =
  /** status 200 OK */ IoIstioTelemetryV1Alpha1Telemetry
export type ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg = {
...
export type PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryApiResponse =
  /** status 200 OK */ IoIstioTelemetryV1Alpha1Telemetry
export type PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryApiArg = {
  /** name of the Telemetry */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiResponse =
  /** status 200 OK */ IoIstioTelemetryV1Alpha1Telemetry
export type ReadTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiArg = {
  /** name of the Telemetry */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiResponse =
  /** status 200 OK */ IoIstioTelemetryV1Alpha1Telemetry
export type PatchTelemetryIstioIoV1Alpha1NamespacedTelemetryStatusApiArg = {
  /** name of the Telemetry */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type ListTelemetryIstioIoV1Alpha1TelemetryForAllNamespacesApiResponse =
  /** status 200 OK */ IoIstioTelemetryV1Alpha1TelemetryList
export type ListTelemetryIstioIoV1Alpha1TelemetryForAllNamespacesApiArg = {
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type IoIstioTelemetryV1Alpha1Telemetry = {
  apiVersion?: string | undefined
              ...
              overrides?:
                | {
                    ...
                    tagOverrides?:
                      | {
                          [key: string]: {
                            operation?: ('UPSERT' | 'REMOVE') | undefined
        ...
        tracing?:
          | {
              ...
              providers?:
                ...
                | undefined
              randomSamplingPercentage?: (number | null) | undefined
            }[]
          | undefined
      }
    | undefined
...
export type IoIstioTelemetryV1Alpha1TelemetryList = {
  apiVersion?: string | undefined
  items: IoIstioTelemetryV1Alpha1Telemetry[]
  kind?: string | undefined
