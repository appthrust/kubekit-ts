...
export const createInstallIstioIoV1Alpha1NamespacedIstioOperator = (
  args: CreateInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg,
  options?: Options
) => {
  return apiClient<CreateInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse>(
    {
      path: `/apis/install.istio.io/v1alpha1/namespaces/${args['namespace']}/istiooperators`,
      method: 'POST',
      body: args.ioIstioInstallV1Alpha1IstioOperator,
      params: {
        pretty: args.pretty,
        dryRun: args.dryRun,
...
export const readInstallIstioIoV1Alpha1NamespacedIstioOperator = (
  args: ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg,
  options?: Options
) => {
  return apiClient<ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse>(
    {
...
export const replaceInstallIstioIoV1Alpha1NamespacedIstioOperator = (
  args: ReplaceInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg,
  options?: Options
) => {
  return apiClient<ReplaceInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse>(
    {
      path: `/apis/install.istio.io/v1alpha1/namespaces/${args['namespace']}/istiooperators/${args.name}`,
      method: 'PUT',
      body: args.ioIstioInstallV1Alpha1IstioOperator,
...
export const deleteInstallIstioIoV1Alpha1NamespacedIstioOperator = (
  args: DeleteInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg,
  options?: Options
) => {
  return apiClient<DeleteInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse>(
    {
      path: `/apis/install.istio.io/v1alpha1/namespaces/${args['namespace']}/istiooperators/${args.name}`,
      method: 'DELETE',
...
export const patchInstallIstioIoV1Alpha1NamespacedIstioOperator = (
  args: PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg,
  options?: Options
) => {
  return apiClient<PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse>(
    {
      path: `/apis/install.istio.io/v1alpha1/namespaces/${args['namespace']}/istiooperators/${args.name}`,
      method: 'PATCH',
...
export const readInstallIstioIoV1Alpha1NamespacedIstioOperatorStatus = (
  args: ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiArg,
  options?: Options
) => {
  return apiClient<ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiResponse>(
    {
...
export const replaceInstallIstioIoV1Alpha1NamespacedIstioOperatorStatus = (
  args: ReplaceInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiArg,
  options?: Options
) => {
  return apiClient<ReplaceInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiResponse>(
    {
      path: `/apis/install.istio.io/v1alpha1/namespaces/${args['namespace']}/istiooperators/${args.name}/status`,
      method: 'PUT',
      body: args.ioIstioInstallV1Alpha1IstioOperator,
...
export const patchInstallIstioIoV1Alpha1NamespacedIstioOperatorStatus = (
  args: PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiArg,
  options?: Options
) => {
  return apiClient<PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiResponse>(
    {
      path: `/apis/install.istio.io/v1alpha1/namespaces/${args['namespace']}/istiooperators/${args.name}/status`,
      method: 'PATCH',
      body: args.ioK8SApimachineryPkgApisMetaV1Patch,
...
export type ListInstallIstioIoV1Alpha1IstioOperatorForAllNamespacesApiResponse =
  /** status 200 OK */ IoIstioInstallV1Alpha1IstioOperatorList
export type ListInstallIstioIoV1Alpha1IstioOperatorForAllNamespacesApiArg = {
...
export type ListInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse =
  /** status 200 OK */ IoIstioInstallV1Alpha1IstioOperatorList
...
export type CreateInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg = {
  ...
  ioIstioInstallV1Alpha1IstioOperator: IoIstioInstallV1Alpha1IstioOperator
}
export type DeleteInstallIstioIoV1Alpha1CollectionNamespacedIstioOperatorApiResponse =
  /** status 200 OK */ IoK8SApimachineryPkgApisMetaV1Status
export type DeleteInstallIstioIoV1Alpha1CollectionNamespacedIstioOperatorApiArg =
  {
    /** object name and auth scope, such as for teams and projects */
    namespace: string
    /** If 'true', then the output is pretty printed. */
...
export type ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse =
  /** status 200 OK */ IoIstioInstallV1Alpha1IstioOperator
export type ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg = {
...
export type PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorApiResponse =
  /** status 200 OK */ IoIstioInstallV1Alpha1IstioOperator
export type PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorApiArg = {
  /** name of the IstioOperator */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiResponse =
  /** status 200 OK */ IoIstioInstallV1Alpha1IstioOperator
export type ReadInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiArg = {
  /** name of the IstioOperator */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiResponse =
  /** status 200 OK */ IoIstioInstallV1Alpha1IstioOperator
export type PatchInstallIstioIoV1Alpha1NamespacedIstioOperatorStatusApiArg = {
  /** name of the IstioOperator */
  name: string
  /** object name and auth scope, such as for teams and projects */
  namespace: string
...
export type IoIstioInstallV1Alpha1IstioOperator = {
  apiVersion?: string | undefined
...
export type IoIstioInstallV1Alpha1IstioOperatorList = {
  apiVersion?: string | undefined
  items: IoIstioInstallV1Alpha1IstioOperator[]
  kind?: string | undefined
