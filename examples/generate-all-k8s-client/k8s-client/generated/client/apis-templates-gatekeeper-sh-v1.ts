...
export const createTemplatesGatekeeperShV1ConstraintTemplate = (
  args: CreateTemplatesGatekeeperShV1ConstraintTemplateApiArg,
  options?: Options
) => {
  return apiClient<CreateTemplatesGatekeeperShV1ConstraintTemplateApiResponse>(
    {
      path: `/apis/templates.gatekeeper.sh/v1/constrainttemplates`,
      method: 'POST',
      body: args.shGatekeeperTemplatesV1ConstraintTemplate,
      params: {
        pretty: args.pretty,
        dryRun: args.dryRun,
...
export const readTemplatesGatekeeperShV1ConstraintTemplate = (
  args: ReadTemplatesGatekeeperShV1ConstraintTemplateApiArg,
  options?: Options
) => {
  return apiClient<ReadTemplatesGatekeeperShV1ConstraintTemplateApiResponse>(
    {
...
export const replaceTemplatesGatekeeperShV1ConstraintTemplate = (
  args: ReplaceTemplatesGatekeeperShV1ConstraintTemplateApiArg,
  options?: Options
) => {
  return apiClient<ReplaceTemplatesGatekeeperShV1ConstraintTemplateApiResponse>(
    {
      path: `/apis/templates.gatekeeper.sh/v1/constrainttemplates/${args.name}`,
      method: 'PUT',
      body: args.shGatekeeperTemplatesV1ConstraintTemplate,
...
export const deleteTemplatesGatekeeperShV1ConstraintTemplate = (
  args: DeleteTemplatesGatekeeperShV1ConstraintTemplateApiArg,
  options?: Options
) => {
  return apiClient<DeleteTemplatesGatekeeperShV1ConstraintTemplateApiResponse>(
    {
      path: `/apis/templates.gatekeeper.sh/v1/constrainttemplates/${args.name}`,
      method: 'DELETE',
...
export const patchTemplatesGatekeeperShV1ConstraintTemplate = (
  args: PatchTemplatesGatekeeperShV1ConstraintTemplateApiArg,
  options?: Options
) => {
  return apiClient<PatchTemplatesGatekeeperShV1ConstraintTemplateApiResponse>(
    {
      path: `/apis/templates.gatekeeper.sh/v1/constrainttemplates/${args.name}`,
      method: 'PATCH',
...
export const readTemplatesGatekeeperShV1ConstraintTemplateStatus = (
  args: ReadTemplatesGatekeeperShV1ConstraintTemplateStatusApiArg,
  options?: Options
) => {
  return apiClient<ReadTemplatesGatekeeperShV1ConstraintTemplateStatusApiResponse>(
    {
...
export const replaceTemplatesGatekeeperShV1ConstraintTemplateStatus = (
  args: ReplaceTemplatesGatekeeperShV1ConstraintTemplateStatusApiArg,
  options?: Options
) => {
  return apiClient<ReplaceTemplatesGatekeeperShV1ConstraintTemplateStatusApiResponse>(
    {
      path: `/apis/templates.gatekeeper.sh/v1/constrainttemplates/${args.name}/status`,
      method: 'PUT',
      body: args.shGatekeeperTemplatesV1ConstraintTemplate,
...
export const patchTemplatesGatekeeperShV1ConstraintTemplateStatus = (
  args: PatchTemplatesGatekeeperShV1ConstraintTemplateStatusApiArg,
  options?: Options
) => {
  return apiClient<PatchTemplatesGatekeeperShV1ConstraintTemplateStatusApiResponse>(
    {
      path: `/apis/templates.gatekeeper.sh/v1/constrainttemplates/${args.name}/status`,
      method: 'PATCH',
      body: args.ioK8SApimachineryPkgApisMetaV1Patch,
...
export type CreateTemplatesGatekeeperShV1ConstraintTemplateApiArg = {
  ...
  shGatekeeperTemplatesV1ConstraintTemplate: ShGatekeeperTemplatesV1ConstraintTemplate
}
...
export type ReadTemplatesGatekeeperShV1ConstraintTemplateApiResponse =
...
export type PatchTemplatesGatekeeperShV1ConstraintTemplateApiResponse =
  /** status 200 OK */ ShGatekeeperTemplatesV1ConstraintTemplate
...
export type PatchTemplatesGatekeeperShV1ConstraintTemplateStatusApiResponse =
  /** status 200 OK */ ShGatekeeperTemplatesV1ConstraintTemplate
...
export type ShGatekeeperTemplatesV1ConstraintTemplate = {
  apiVersion?: string | undefined
...
export type ShGatekeeperTemplatesV1ConstraintTemplateList = {
  apiVersion?: string | undefined
  items: ShGatekeeperTemplatesV1ConstraintTemplate[]
  kind?: string | undefined
